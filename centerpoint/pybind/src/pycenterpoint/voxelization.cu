...
const int POINTS_PER_VOXEL = 32; //  config['voxelization']['max_points_per_voxel']
const int WARP_SIZE = 32; // config['voxelization']['max_points_per_voxel']
const int WARPS_PER_BLOCK = 4; // config['voxelization']['num_feature']
const int FEATURES_SIZE = 10; // config['voxelization']['num_voxel_feature']
