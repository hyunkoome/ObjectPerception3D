...
def eval_one_epoch_with_tensorrt(cfg, args, model, dataloader, epoch_id, logger, dist_test=False, result_dir=None):
    ...
    for i, batch_dict in enumerate(dataloader):
        ...
        # cfg['DATA_CONFIG']['DATA_PROCESSOR'][2]['MAX_NUMBER_OF_VOXELS']['test']
        # print('the index of datasets', i)
        # print('the name of datasets', batch_dict['frame_id'])
        # print('# of points : ', len(batch_dict['points']))
