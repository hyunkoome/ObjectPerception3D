...
if __name__ == '__main__':
    ...
    setup(
        ...
        # need create data: 'iou3d_nms_cuda', 'roiaware_pool3d_cuda
        ext_modules=[
            make_cuda_ext(
                name='iou3d_nms_cuda',
                module='lidar.iou3d_nms',
                sources=[
                    'cpp_cuda/iou3d_cpu.cpp',
                    'cpp_cuda/iou3d_nms_api.cpp',
                    'cpp_cuda/iou3d_nms.cpp',
                    'cpp_cuda/iou3d_nms_kernel.cu',
                ]
            ),
            make_cuda_ext(
                name='roiaware_pool3d_cuda',
                module='lidar.roiaware_pool3d',
                sources=[
                    'cpp_cuda/roiaware_pool3d.cpp',
                    'cpp_cuda/roiaware_pool3d_kernel.cu',
                ]
            ),
            # make_cuda_ext(
            #     name='iou3d_nms_cuda',
            #     module='lidardet.ops.iou3d_nms',
            #     sources=[
            #         'src/iou3d_cpu.cpp',
            ...
            # make_cuda_ext(
            #     name='roiaware_pool3d_cuda',
            #     module='lidardet.ops.roiaware_pool3d',
            #     sources=[
